...
export default function ManufacturerHero(manufacturer: IManufacturer) {
  ...
  return (
    <div className="max-w-full mx-auto mb-6" id="manufacturer-hero">
      <div className="grid grid-cols-2 grid-rows-1 mx-auto mb-6 h-[50vh] md:h-[50vh]">
        <div className="z-20 h-full col-span-2 col-start-1 row-span-1 row-start-1 bg-[#000000] opacity-50 mix-blend-multiply" />
        <GatsbyImage
      ...
      <div className="z-20 max-w-6xl px-2 mx-auto md:px-6">
